...
class Configs:
    def __init__(self):
        ...
        self.d_model = 128
        self.d_ff = 128
        self.e_layers = 3        # iTransformer 推荐 3 层
        self.dropout = 0.1
        self.embed = 'timeF'
        self.freq = 'h'
        self.c_out = 2
...
def main():
    ...
    model_path = os.path.join(checkpoint_dir, "best_mean_iTransformer_model.pt")
    best_val_acc = 0

    print("\nStart training iTransformer...")
