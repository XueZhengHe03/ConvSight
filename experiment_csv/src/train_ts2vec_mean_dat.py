# src/train_ts2vec_mean_dat.py
# 使用 Mean Centering 预处理的数据训练 TS2Vec
import sys
import os
import numpy as np
import torch
...
def main():
    ...
    model_path = os.path.join(checkpoint_dir, "best_convergence_model_mean_dat.pt")
    best_val_acc = 0

    print("\nStart training TS2Vec (Mean Centering, dat dataset)...")
