...
def main():
    ...
    model_path = os.path.join(checkpoint_dir, "best_iTransformer_model_dat.pt")
    best_val_acc = 0

    print("\nStart training iTransformer (dat dataset)...")
