# src/evaluate_Nonstationary_Transformer_dat.py
import sys
import os
import numpy as np
import torch
...
def main():
    ...
    model_path = os.path.join(checkpoint_dir, "best_Nonstationary_Transformer_model_dat.pt")
    ...
    # DataLoader
    batch_size = 32
    test_loader = DataLoader(TensorDataset(X_test_t, x_mark_enc_test, y_test_t), batch_size=batch_size, shuffle=False)
    ...
    print(f"\n✅ Non-stationary Transformer Final Test Results (dat dataset):")
